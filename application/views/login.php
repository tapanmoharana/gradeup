		...
		<div class="signin-form">
			...
			<form action="<?=site_url('login')?>" id="signin-form_id" method="post">
				...
				<div class="form-group w-icon">
					<input type="text" name="signin_username" id="username_id" class="form-control input-lg" placeholder="Username or email" required>
					<span class="fa fa-user signin-form-icon"></span>
				</div> <!-- / Username -->

				<div class="form-group w-icon">
					<input type="password" name="signin_password" id="password_id" autocomplete="off" class="form-control input-lg" placeholder="Password" required>
					<span class="fa fa-lock signin-form-icon"></span>
				</div> <!-- / Password -->

				<div class="form-actions">
					<input type="submit" name="submit" value="SIGN IN" class="signin-btn " style="background-color: #D68F14;color: white">
