...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Video</h1>
                    ...
                    <div class="table-info">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>YouTube URL</td>
                                <td>
                                    <input type="text" id="youtube_url" name="youtube_url" class="form-control" value="<?=isset($_REQUEST['youtube_url'])?$_REQUEST['youtube_url']:''?>" /> 
