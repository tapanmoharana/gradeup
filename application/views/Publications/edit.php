...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Edit Publication</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Publication</h1>
            ...
            <div class="col-sm-12">
                ...
                <div class="panel-body">
                    <div class="table-info">
                        <?php
                        //echo "<pre>";print_r($publications_details); die;
                        ?>
                        ...
                        <tbody>
                            <tr>
                                <td>Date</td>
                                <td>
                                    <input type="hidden" id="id" name="id" value="<?=isset($publications_details['pub_id'])?$publications_details['pub_id']:''?>" class="form-control" />
                                    <input type="text" id="dt" name="dt" class="form-control input-group" value="<?=isset($publications_details['dt'])?$publications_details['dt']:''?>" /> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="type" name="type" class="form-control"> 
                                        ...
                                        <option <?=$publications_details['type']=="N"?"selected='selected'":""?> value="N">News</option>
                                        <option <?=$publications_details['type']=="P"?"selected='selected'":""?> value="P">Publications</option>
                                    </select>
                            ...
                            <tr>
                                <td>Title</td>
                                <td>
                                    <input type="text" id="title" name="title" class="form-control" value="<?=isset($publications_details['title'])?$publications_details['title']:''?>" /> 
                            ...
                            <tr>
                                <td>Description</td>
                                <td>                                    
                                    <?php echo form_textarea(array('name' =>'description','id'=>'description','class'=>"ckeditor","value"=>isset($publications_details['description'])?htmlspecialchars_decode($publications_details['description']):'')); ?>
