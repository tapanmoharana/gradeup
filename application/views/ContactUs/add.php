...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Contact</h1>
                                ...
                                <tbody>
                                    <tr>                                        
                                        ...
                                        <td>                                    
                                            ...
                                            <input type="text" id="lat" name="lat" class="form-control" value="<?=isset($_REQUEST['lat'])?$_REQUEST['lat']:''?>" /> 
                                    ...
                                    <tr>
                                        <td>Longitude</td>
                                        <td>
                                            <input type="text" id="longt" name="longt" class="form-control" value="<?=isset($_REQUEST['longt'])?$_REQUEST['longt']:''?>" /> 
                                    ...
                                    <tr>
                                        <td>Address</td>
                                        <td>                                    
                                            <?php echo form_textarea(array('name' =>'address','id'=>'address','rows'=>3,'cols'=>125)); ?>
