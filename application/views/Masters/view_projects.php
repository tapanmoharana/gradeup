...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Project Master</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Project Master</h1>
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    <hr class="visible-xs no-grid-gutter-h">
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_project")?>"><span class="btn-label icon fa fa-plus"></span>Add New Project</a></div>                        
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?php //=$slokas_details[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                                <td><?=$j?></td>
								   <td><?=$slokas_details[$i]['project_name']?></td>
                             <td><?=$slokas_details[$i]['location_name']?></td>
							   <td><?=$slokas_details[$i]['cityname']?></td>
							     <td><?=$slokas_details[$i]['ptype']?></td>
								   <td><?=$slokas_details[$i]['pstatus']?></td>
