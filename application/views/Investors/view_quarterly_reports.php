        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    ...
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/annual_report")?>"><span class="btn-label icon fa fa-plus"></span>Add New</a></div>                        
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?php //=$slokas_details[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                                <td><?=$j?></td>
								   <td><?=$slokas_details[$i]['year']?></td>
                      <td><?=$slokas_details[$i]['title']?></td>
						                      <td><?=$slokas_details[$i]['document']?></td>		
