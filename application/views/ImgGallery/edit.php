...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Edit Image</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Image</h1>
                    ...
                    <div class="table-info">
                        ...
                        <tbody>
                            <tr>
                                <td>Date</td>
                                <td>
                                    <input type="hidden" id="id" name="id" value="<?=isset($image_details['gid'])?$image_details['gid']:''?>" class="form-control" />
                                    <input type="text" id="dt" name="dt" class="form-control input-group" value="<?=isset($image_details['udt'])?$image_details['udt']:''?>" /> 
                            ...
                            <tr>
                                <td>Title</td>
                                <td>
                                    <input type="text" id="title" name="title" class="form-control" value="<?=isset($image_details['title'])?$image_details['title']:''?>" /> 
                            ...
                            <tr>
                                <td>Description</td>
                                <td>                                    
                                    <?php echo form_textarea(array('name' =>'description','id'=>'description','class'=>"ckeditor","value"=>isset($image_details['description'])?htmlspecialchars_decode($image_details['description']):'')); ?>
