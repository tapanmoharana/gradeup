...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Sloks</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Sloks</h1>
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    <hr class="visible-xs no-grid-gutter-h">
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add")?>"><span class="btn-label icon fa fa-plus"></span>Add Sloks</a></div>                        
                        ...
                        <div class="input-group no-margin">
                            <span style="border:none;background: #fff;background: rgba(0,0,0,.05);" class="input-group-addon"><i class="fa fa-search"></i></span>
                                ...
                                <?php
                                    ...
                                    {
                                ?>
                                <option value="<?=$slokas_details[$i]['title']?>"><?=$slokas_details[$i]['title']?></option>
                                <?php
                                    }
                                ?>
                            </select>
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">Slok Details</span>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            <tr <?=$slokas_details[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                                <td><?=$j?></td>
                                <td><?=$slokas_details[$i]['title']?></td>
                                <td><?=$slokas_details[$i]['description']?></td>
                                <td><a target="_blank" title="Download" href="<?=base_url()."uploads/slokas/".$slokas_details[$i]['attachment']?>"><i class="fa fa-download"></i></a></td>
                                <td>
                                    <a href="<?=base_url($currentModule."/edit/".$slokas_details[$i]['sid'])?>"><i class="fa fa-edit"></i></a>                                                                        
                                    <a href='<?=$slokas_details[$i]["status"]=="Y"?"disable/".$slokas_details[$i]["sid"]:"enable/".$slokas_details[$i]["sid"]?>'><i class='fa <?=$slokas_details[$i]["status"]=="Y"?"fa-ban":"fa-check"?>' title='<?=$slokas_details[$i]["status"]=="Y"?"Disable":"Enable"?>'></i></a>
                                </td>
                            </tr>
                            <?php
                            $j++;
