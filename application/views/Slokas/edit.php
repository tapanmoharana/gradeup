...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Edit Slok</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Slok</h1>
            ...
            <div class="col-sm-12">
                ...
                <div class="panel-body">
                    <div class="table-info">
                        <?php echo form_open_multipart('Slokas/submit');?>
                            <table class="table table-bordered">                       
                        <tbody>
                            <tr>
                                <td>Title</td>
                                <td>
                                    <input type="hidden" id="id" name="id" value="<?=isset($slokas_details['sid'])?$slokas_details['sid']:''?>" class="form-control" />
                                    <input type="text" id="title" name="title" class="form-control" value="<?=isset($slokas_details['title'])?$slokas_details['title']:''?>" /> 
                            ...
                            <tr>
                                <td>Description</td>
                                <td>                                    
                                    <?php echo form_textarea(array('name' =>'description','id'=>'description','class'=>"ckeditor",'value'=>isset($slokas_details['description'])?$slokas_details['description']:'')); ?>
