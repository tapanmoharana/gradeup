...
class VideoGallery extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        $this->data['video_details']=$this->gallary_model->get_videos_details();                
        $this->load->view('VideoGallery/view',$this->data);
    ...
    {
        $this->load->view('header',$this->data);        
        $this->load->view('VideoGallery/add',$this->data);
        $this->load->view('footer');
    }
    ...
    public function edit()
    {
        ...
        $this->data['video_details']=  array_shift($this->gallary_model->get_videos_details($gid));                    
        $this->load->view('VideoGallery/edit',$this->data);
        $this->load->view('footer');
    }    
    ...
    public function disable()
    {
        ...
        {
            redirect(base_url("VideoGallery/view?error=0"));
        }
        else
        {
            redirect(base_url("VideoGallery/view?error=1"));
        }  
        $this->load->view('footer');
    }
    ...
    public function submit()
    {
        ...
        $target_dir = "uploads/gallary/videos/";
...
//                }
                ...
                $insert_array=array("type"=>"V","upload_date"=>$dt,"title"=>$title,"description"=>$description,"attachment"=>$attachment,"inserted_by"=>$this->session->userdata("uid"),"inserted_datetime"=>date("Y-m-d H:i:s"));                                
                if($youtube_url!="")
                {
                    $insert_array['youtube_url']=$youtube_url;
                }
        ...
        else
        {
            ...
            {                
                ...
                redirect(base_url("VideoGallery/view"));
            }
        }      
     }
    ...
    {        
        $title=$this->input->post("title");
        $videos_details=  $this->gallary_model->get_videos_details_search($title);                                    
        echo json_encode(array("videos_details"=>$videos_details));
    }
